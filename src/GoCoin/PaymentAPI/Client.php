...
class Client
{
    ...
    */
    ...
    public function  __construct($options)
    {
        ...
        $this->options = $this->setDefaultValue($options, $this->default_options);
    ...
    */
    ...
    public function getTokenFromRequest()
    {
        if (isset($_GET['code'])) {
            ...
            $options['redirect_uri'] = $this->getCurrentURL();
    ...
    */
    ...
    public function requestClient($secure)
    {
        if ($secure === null) {
            $secure = true;
        }
    ...
    */
    ...
    public function rawRequest($config)
    {
    ...
    */
    ...
    public function getXRate()
    {
        ...
        $result = $this->doRequest($xrate_config['url'], '', '', $xrate_config['method']);
    ...
    public function doRequest($url, $params=false, $headers, $method="POST")
    {
        if (!isset($ch)) {
          $ch = curl_init();
        }
